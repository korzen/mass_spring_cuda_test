...
int para::frame=500;
int para::line_search=1;
double para::weight_line_search=1e-5;
string para::input_object="./input_data/cloth/cloth_fine.vtk",para::input_constraint="./input_data/cloth/cloth_3.csv";
string para::force_function="gravity";
double para::radius=0.105;
