...
template<typename T,size_t dim>
int edge<T,dim>::calJacobian(vector< vertex<T,dim> > &myvertexs,Eigen::VectorXd &Jacobian,T stiffness,const std::string &newton_fastMS)
{ 
  {
    typedef DScalar1<T,VectorXd > DScalar; // use DScalar2 for calculating gradient and hessian and use DScalar1 for calculating gradient
...
template<typename T,size_t dim>
int edge<T,dim>::calJacobianAndHessian(vector< vertex<T,dim> > &myvertexs,std::vector<Eigen::Triplet<double> > &tripletsForHessian,Eigen::VectorXd &Jacobian,T stiffness,const std::string &newton_fastMS)
{ 
  {
    typedef DScalar2<T,VectorXd, MatrixXd> DScalar; // use DScalar2 for calculating gradient and hessian and use DScalar1 for calculating gradient
